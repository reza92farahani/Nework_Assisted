...
server_ctrl_ip = []
server_ctrl_ip.append("155.98.37.88")
server_ctrl_ip.append("155.98.37.86")
server_ctrl_ip.append("155.98.37.87")
server_ctrl_ip.append("155.98.37.85")
server_ctrl_ip.append("155.98.37.89")
...
def _forward_path():
    ...
    for i in range(len(s_keys)):
        for j in range(len(s_keys[i])):
            ...
            post = {"server_ip": server_list[j], "client_ip": clientip_list[i], "min_bw": (min_bw),
                    "hop_count": hop_count, "date": datetime.utcnow()}
